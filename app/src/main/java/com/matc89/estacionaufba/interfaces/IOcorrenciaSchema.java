...
public interface IOcorrenciaSchema {
    ...
    String[] OCORRENCIA_COLUMNS = new String[]{COLUMN_ID, COLUMN_TITULO, COLUMN_DESCRICAO, COLUMN_LOCAL,
            COLUMN_LATITUDE, COLUMN_LONGITUDE, COLUMN_STATUS, COLUMN_USER_ID, COLUMN_DATE_CREATED,
            COLUMN_DATE_UPDATED};
    ...
    String CREATE_OCORRENCIA_TABLE = "create table " + OCORRENCIA_TABLE + "( " + COLUMN_ID + " integer primary key autoincrement," +
            ...
            " varchar(20) not null, " + COLUMN_LOCAL + " varchar(30) not null, " + COLUMN_LATITUDE + " real not null, " +
            COLUMN_LONGITUDE + " real not null, " + COLUMN_STATUS + " int not null, " + COLUMN_DATE_CREATED +
            " datetime not null, " + COLUMN_DATE_UPDATED + " datetime, " + COLUMN_USER_ID + " int not null " + ");";
