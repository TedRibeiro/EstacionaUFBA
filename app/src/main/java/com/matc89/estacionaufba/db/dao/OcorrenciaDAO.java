...
public class OcorrenciaDAO extends DaoHelper<Ocorrencia> implements IOcorrenciaSchema {
    ...
    protected Ocorrencia cursorToEntity(Cursor cursor) {
        ...
        ocorrencia.setLocal(cursor.getString(4));
        ocorrencia.setLatitude(cursor.getDouble(5));
        ocorrencia.setLongitude(cursor.getDouble(6));
        ocorrencia.setStatus(cursor.getLong(7));
        ocorrencia.setUserId(cursor.getLong(8));
        ocorrencia.setDateCreated(cursor.getString(9));
        ocorrencia.setDateUpdated(cursor.getString(10));
        return ocorrencia;
    }
