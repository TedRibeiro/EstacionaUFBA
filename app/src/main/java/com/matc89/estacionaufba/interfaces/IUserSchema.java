...
public interface IUserSchema {
    ...
    String[] USER_COLUMNS = new String[]{COLUMN_ID, COLUMN_NOME, COLUMN_EMAIL, COLUMN_PASSWORD, COLUMN_PLACA_CARRO,
    ...
    String CREATE_USER_TABLE = "create table " + USER_TABLE + "( " + COLUMN_ID + " integer primary key autoincrement," +
            " " + COLUMN_NOME + " varchar(50) not null, " + COLUMN_EMAIL + " varchar(50) not null, " +
